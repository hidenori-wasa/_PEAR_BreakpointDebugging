...
class BreakpointDebugging_ExceptionTest extends \BreakpointDebugging_UnitTestOverriding
{
    ...
    public function test__construct_A()
    {
        ...
        new \BreakpointDebugging_Exception('Test message.', 1, 0, $previous);
        new \BreakpointDebugging_Exception('Test message.', 1, 0);
    ...
    {
        new \BreakpointDebugging_Exception('OK', 1, 'Error');
    }
    ...
    {
        new \BreakpointDebugging_Exception('OK', 1, -1);
    }
    ...
    {
        new \BreakpointDebugging_Exception('OK', 1, 1, 'Error');
    }
    ...
    public function test__construct_H()
    {
        $previous = new \Exception('Previous message.');
        // SJIS message.
        new \BreakpointDebugging_Exception("\x95\xB6\x8E\x9A", 1, 1, $previous);
    }
