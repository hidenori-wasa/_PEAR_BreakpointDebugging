...
class BreakpointDebugging_InAllCaseTest extends \BreakpointDebugging_PHPUnitStepExecution_PHPUnitFrameworkTestCase
{
    ...
    public function testClearRecursiveArrayElement()
    {
        ...
        $this->assertTrue($expectedArray['recursive'] === $resultArray['recursive']);
        $this->assertTrue($expectedArray['component']['recursive'] === $resultArray['component']['recursive']);
        $this->assertTrue($expectedArray['component']['element'] === $resultArray['component']['element']);
        $this->assertTrue($expectedArray['component']['recursive2'] === $resultArray['component']['recursive2']);
        $this->assertTrue($expectedArray['component']['component']['recursive'] === $resultArray['component']['component']['recursive']);
        $this->assertTrue($expectedArray['component']['component']['GLOBALS'] === $resultArray['component']['component']['GLOBALS']);
        $this->assertTrue(is_array($GLOBALS));

        $resultArray = BA::clearRecursiveArrayElement($GLOBALS);
        $this->assertTrue(B::GLOBALS_USING === $resultArray['GLOBALS']);
        $this->assertTrue(is_array($GLOBALS));
        ...
        $resultArray = BA::clearRecursiveArrayElement($testArray);
        $this->assertTrue(B::GLOBALS_USING === $resultArray[0]);
        $this->assertTrue(is_array($GLOBALS));
    }
